...
def predict(saved=None, softmax_tensor2=None):
    ...
    if not saved:
        output=tf_vision_faster1.vision_pred('./input_resized/resized_input.jpg')

    else:
        output=tf_vision_faster1.vision_pred('./input_resized/resized_input.jpg',saved,softmax_tensor2)
